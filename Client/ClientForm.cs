...
namespace Client
{
    ...
    /// </summary>
    public partial class ClientForm : Form, UpDateUI, ClientReceive
    {
        ...
        public void ClientReceive(Content content)
        {
            // Cho server đánh ở client
            if (content.isRight)
            {
                game.playerOneRight(content.index);
            }
            else
            {
                game.playerOneLeft(content.index);
            }
        ...
        private void right_Click(object sender, EventArgs e)
        {
            ...
            game.playerTwoRight(mPosition);

            // Chuyển qua server chơi
            mPlayer = 1;
            PlayGame();
        }
